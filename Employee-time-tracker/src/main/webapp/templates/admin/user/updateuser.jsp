		...
		<div class="register-form">
			...
			<form action="update-record ">
				<div class="form-group">
					<label for="userid">User ID<span>*</span>
					</label> <input type="text" class="form-control" id="userid" name="userid"
						value="${umsg.userid }" readonly="readonly" required>
				</div>
				<div class="form-group">
					<label for="password">Password<span>*</span></label> <input
						class="form-control" type="password" id="password" name="password"
						value="${umsg.password }" required>
				</div>
				<div class="form-group">
					<label for="name">Name<span>*</span></label> <input
						class="form-control" type="text" id="name" name="name"
						value="${umsg.name }" required>
				</div>
				<div class="form-group">
					<label for="phone">Phone Number<span>*</span>
					</label> <input class="form-control" type="number" id="phone" name="phone"
						value="${umsg.phone }" required>
				</div>
				<button type="submit" formaction="update-user" class="btn-submit">Submit</button>
			</form>
